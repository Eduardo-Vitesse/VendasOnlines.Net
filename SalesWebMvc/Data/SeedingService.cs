...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Luiz Eduardo", "luiz@gmail.com", new DateTime(1993 - 09 - 16), 1000.0, d1);
            Seller s2 = new Seller(2, "Anna Claudia", "anna@gmail.com", new DateTime(1997 - 03 - 30), 1000.0, d2);
            Seller s3 = new Seller(3, "João Marcello", "jm9@gmail.com", new DateTime(1995 - 10 - 22), 1000.0, d1);
            Seller s4 = new Seller(4, "Polyani Corea", "poly@gmail.com", new DateTime(1999 - 01 - 06), 1000.0, d4);
            Seller s5 = new Seller(5, "Marcus Vinicius", "magu@gmail.com", new DateTime(2001 - 07 - 24), 1000.0, d3);
            Seller s6 = new Seller(6, "Edineimar", "neima@gmail.com", new DateTime(1965 - 11 - 23), 1000.0, d2);
